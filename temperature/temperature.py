...
class TemperatureSensor:
    def __init__(self):
        ...
        self.device_file = '/sys/bus/w1/devices/28-01131a3de1fd/w1_slave'
...
while True:
    print('la temperature est de : '+ str(michel.read_temp_c()) +'degré Celsius')
    print('la temperature est de : '+ str(michel.read_temp_f()) +'degré Fahrenheit')
    time.sleep(1)
